				...
				<div class="col-lg-6">
					...
					<div class="product-thumbs">
						<div class="product-thumbs-track">
							<div class="pt" data-imgbigurl="{{asset('frontend')}}/img/product/1.jpg"><img src="img/product/thumb-1.jpg" alt=""></div>
							<div class="pt" data-imgbigurl="{{asset('frontend')}}/img/product/2.jpg"><img src="img/product/thumb-2.jpg" alt=""></div>
							<div class="pt" data-imgbigurl="{{asset('frontend')}}/img/product/3.jpg"><img src="img/product/thumb-3.jpg" alt=""></div>
							<div class="pt" data-imgbigurl="{{asset('frontend')}}/img/product/4.jpg"><img src="img/product/thumb-4.jpg" alt=""></div>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="product-content">
						...
						<div class="pc-meta">
							<h4 class="price">৳{{ $single_product_info->price }}</h4>
							<div class="review">
								<div class="rating">
						...
						<div class="size-choose">
                            ...
                            @if ( $single_product_info->product_stock > 0 )
					...
					<div class="col-lg-10 offset-lg-1">
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                                <p>{{ $single_product_info->product_description }}
                                </p>
							</div>
